...
export class LendingPoolDictionary {
  public static pools: Map<Asset, LendingPool> = new Map<Asset, LendingPool>([
    ...
    [
      Asset.BUSD,
      new LendingPool('BUSD', Asset.BUSD, [Asset.BUSD, Asset.JFIN, Asset.GASH]),
    ],
    // eslint-disable-next-line
    [
      Asset.JFIN,
      new LendingPool('JFIN', Asset.JFIN, [Asset.BUSD, Asset.JFIN, Asset.GASH]),
    ],
    // eslint-disable-next-line
    [
      Asset.GASH,
      new LendingPool('GASH', Asset.GASH, [Asset.BUSD, Asset.JFIN, Asset.GASH]),
    ],
    // eslint-disable-next-line
    [
      Asset.ETH,
      new LendingPool('ETH', Asset.ETH, [Asset.BUSD, Asset.JFIN, Asset.GASH]),
    ],
    ...
    [
      Asset.ALPHA,
      new LendingPool('ALPHA', Asset.ALPHA, [
        Asset.BUSD,
        Asset.JFIN,
        Asset.GASH,
        Asset.ETH,
    ...
    // [
    //   Asset.WBTC,
    //   new LendingPool('WBTC', Asset.WBTC, [
    //     Asset.BUSD,
    //     Asset.JFIN,
    //     Asset.GASH,
    //     Asset.ETH,
    ...
    [
      Asset.DOGE,
      new LendingPool('DOGE', Asset.DOGE, [
        Asset.BUSD,
        Asset.JFIN,
        Asset.GASH,
        Asset.ETH,
    ...
    [
      Asset.BAND,
      new LendingPool('BAND', Asset.BAND, [
        Asset.BUSD,
        Asset.JFIN,
        Asset.GASH,
        Asset.ETH,
